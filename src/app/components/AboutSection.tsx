  ...
  return (
    <section id="about" className="bg-white">
      <div className="container-limited">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 pt-16 border-t border-accent/10">
          {/* Mission Card */}
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            whileInView={{ opacity: 1, scale: 1 }}
            ...
            transition={{ duration: 0.8 }}
            whileHover={{ y: -10 }}
            className="group relative bg-secondary p-10 lg:p-14 rounded-[40px] border border-accent/5 hover:border-accent/20 hover:bg-white hover:shadow-2xl transition-all duration-500 flex flex-col"
          >
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-10 shadow-sm group-hover:bg-accent transition-all duration-500">
